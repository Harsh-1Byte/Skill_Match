...
router.route("/discover").get(discoverUsers);

// get featured users for home page
router.route("/featured").get(getFeaturedUsers);

// test database endpoint
router.route("/test-database").get(testDatabase);
